...
static void lcd_sdcard_menu();
	...
	static void action_laser_test_40_50ms();
	static void action_laser_test_40_100ms();
  static void action_laser_test_50_75ms();
...
static void lcd_main_menu()
{
    ...
    if (movesplanned() || IS_SD_PRINTING)
    {
        ...
        MENU_ITEM(function, "Fire 50% 75ms ", action_laser_test_50_75ms);
    }
...
static void lcd_laser_test_fire_menu() {
	...
	MENU_ITEM(function, " 40% 50ms ", action_laser_test_40_50ms);
	MENU_ITEM(function, " 40% 100ms ", action_laser_test_40_100ms);
